...
min_model_test_fit <- lmerTest::lmer(proportion_correct_notes ~ 
                          avg_score + (1|user_id) + (1|item_id) + (1|user_id:item_id), data = test_data)
...
MuMIn::r.squaredGLMM(min_model_test_fit)
